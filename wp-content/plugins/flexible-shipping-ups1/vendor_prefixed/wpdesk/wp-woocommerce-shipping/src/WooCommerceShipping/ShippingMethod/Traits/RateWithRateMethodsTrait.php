...
trait RateWithRateMethodsTrait
{
     ...
     */
    private function handle_rating_using_methods(\Psr\Log\LoggerInterface $logger, \UpsFreeVendor\WPDesk\AbstractShipping\ShippingService $service, array $package, \UpsFreeVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $metadata_builder)
    {
